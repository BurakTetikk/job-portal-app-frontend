...
const Hero = () => {
  ...
  const user = { fullName: "Burak Tetik", role: "employer" }; // Replace with actual user data
  const stats = [
    { icon: Users, label: "Active Users", value: "2.4M+" },
    { icon: Building2, label: "Companies", value: "50K+" },
    { icon: TrendingUp, label: "Job Posted", value: "1.2M+" },
  ];
    ...
    <section className="pt-24 pb-16 bg-white min-h-screen flex items-center">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Connect talented professionals with inovative companies. Your next
          ...
          >
            ...
            >
              ...
              <span>Find Jobs</span>
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transation-transform" />
            </motion.button>
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
